...
final readonly class CardsDto
{
    public function __construct(
        private InputDto $cardSpacerY = new InputDto(label: 'Card Spacer Y', type: InputTypeEnum::SIZE, default: '$spacer'),
        private InputDto $cardSpacerX = new InputDto(label: 'Card Spacer X', type: InputTypeEnum::SIZE, default: '$spacer'),
        private InputDto $cardTitleSpacerY = new InputDto(label: 'Card Title Spacer Y', type: InputTypeEnum::SIZE, default: '$spacer * .5'),
        ...
        private InputDto $cardBorderWidth = new InputDto(label: 'Card Border Width', type: InputTypeEnum::SIZE, default: 'var(--#{$prefix}border-width)'),
        private InputDto $cardBorderColor = new InputDto(label: 'Card Border Color', type: InputTypeEnum::COLOR, default: 'var(--#{$prefix}border-color-translucent)'),
        private InputDto $cardBorderRadius = new InputDto(label: 'Card Border Radius', type: InputTypeEnum::SIZE, default: 'var(--#{$prefix}border-radius)'),
        private InputDto $cardBoxShadow = new InputDto(label: 'Card Box Shadow', type: InputTypeEnum::STRING, default: 'null'), // Assuming string type
        private InputDto $cardInnerBorderRadius = new InputDto(label: 'Card Inner Border Radius', type: InputTypeEnum::SIZE, default: 'subtract($card-border-radius, $card-border-width)'),
        ...
        private InputDto $cardHeight = new InputDto(label: 'Card Height', type: InputTypeEnum::SIZE, default: 'null'), // Assuming size type
        private InputDto $cardColor = new InputDto(label: 'Card Color', type: InputTypeEnum::COLOR, default: 'null'), // Assuming color type
        private InputDto $cardBg = new InputDto(label: 'Card Bg', type: InputTypeEnum::COLOR, default: 'var(--#{$prefix}body-bg)'),
        private InputDto $cardImgOverlayPadding = new InputDto(label: 'Card Img Overlay Padding', type: InputTypeEnum::SIZE, default: '$spacer'),
        private InputDto $cardGroupMargin = new InputDto(label: 'Card Group Margin', type: InputTypeEnum::SIZE, default: '$grid-gutter-width * .5')
    )
    {
    }
