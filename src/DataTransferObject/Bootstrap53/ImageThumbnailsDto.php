...
final readonly class ImageThumbnailsDto
{
    public function __construct(
        private InputDto $thumbnailPadding = new InputDto(label: 'Thumbnail Padding', type: InputTypeEnum::SIZE, default: '.25rem' , isLocked: true),
        ...
        private InputDto $thumbnailBorderWidth = new InputDto(label: 'Thumbnail Border Width', type: InputTypeEnum::SIZE, default: 'var(--#{$prefix}border-width)' , isLocked: true),
        ...
        private InputDto $thumbnailBoxShadow = new InputDto(label: 'Thumbnail Box Shadow', type: InputTypeEnum::STRING, default: 'var(--#{$prefix}box-shadow-sm)' , isLocked: true) // Assuming it's a string
    )
    {
    }
