...
final readonly class CarouselDto
{
    public function __construct(
        ...
        private InputDto $carouselControlWidth = new InputDto(label: 'Carousel Control Width', type: InputTypeEnum::SIZE, default: '15%'),
        private InputDto $carouselControlOpacity = new InputDto(label: 'Carousel Control Opacity', type: InputTypeEnum::FLOAT, default: '.5'),
        private InputDto $carouselControlHoverOpacity = new InputDto(label: 'Carousel Control Hover Opacity', type: InputTypeEnum::FLOAT, default: '.9'),
        private InputDto $carouselControlTransition = new InputDto(label: 'Carousel Control Transition', type: InputTypeEnum::STRING, default: 'opacity .15s ease'), // Not sure if this should be a specific type

        private InputDto $carouselIndicatorWidth = new InputDto(label: 'Carousel Indicator Width', type: InputTypeEnum::SIZE, default: '30px'),
        private InputDto $carouselIndicatorHeight = new InputDto(label: 'Carousel Indicator Height', type: InputTypeEnum::SIZE, default: '3px'),
        private InputDto $carouselIndicatorHitAreaHeight = new InputDto(label: 'Carousel Indicator Hit Area Height', type: InputTypeEnum::SIZE, default: '10px'),
        private InputDto $carouselIndicatorSpacer = new InputDto(label: 'Carousel Indicator Spacer', type: InputTypeEnum::SIZE, default: '3px'),
        private InputDto $carouselIndicatorOpacity = new InputDto(label: 'Carousel Indicator Opacity', type: InputTypeEnum::FLOAT, default: '.5'),
        ...
        private InputDto $carouselIndicatorActiveOpacity = new InputDto(label: 'Carousel Indicator Active Opacity', type: InputTypeEnum::FLOAT, default: '1'),
        private InputDto $carouselIndicatorTransition = new InputDto(label: 'Carousel Indicator Transition', type: InputTypeEnum::STRING, default: 'opacity .6s ease'), // Not sure if this should be a specific type

        private InputDto $carouselCaptionWidth = new InputDto(label: 'Carousel Caption Width', type: InputTypeEnum::SIZE, default: '70%'),
        private InputDto $carouselCaptionColor = new InputDto(label: 'Carousel Caption Color', type: InputTypeEnum::COLOR, default: '$white'),
        private InputDto $carouselCaptionPaddingY = new InputDto(label: 'Carousel Caption Padding Y', type: InputTypeEnum::SIZE, default: '1.25rem'),
        private InputDto $carouselCaptionSpacer = new InputDto(label: 'Carousel Caption Spacer', type: InputTypeEnum::SIZE, default: '1.25rem'),

        private InputDto $carouselControlIconWidth = new InputDto(label: 'Carousel Control Icon Width', type: InputTypeEnum::SIZE, default: '2rem'),

        private InputDto $carouselControlPrevIconBg = new InputDto(label: 'Carousel Control Prev Icon Bg', type: InputTypeEnum::STRING, default: 'url("data:image/svg+xml,<svg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 16 16\' fill=\'#{$carousel-control-color}\'><path d=\'M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0z\'/></svg>")'), // Not sure if this should be a specific type
        private InputDto $carouselControlNextIconBg = new InputDto(label: 'Carousel Control Next Icon Bg', type: InputTypeEnum::STRING, default: 'url("data:image/svg+xml,<svg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 16 16\' fill=\'#{$carousel-control-color}\'><path d=\'M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z\'/></svg>")'), // Not sure if this should be a specific type

        private InputDto $carouselTransitionDuration = new InputDto(label: 'Carousel Transition Duration', type: InputTypeEnum::STRING, default: '.6s'),
        private InputDto $carouselTransition = new InputDto(label: 'Carousel Transition', type: InputTypeEnum::STRING, default: 'transform .6s ease-in-out'), // Not sure if this should be a specific type
        ...
        private InputDto $carouselDarkControlIconFilter = new InputDto(label: 'Carousel Dark Control Icon Filter', type: InputTypeEnum::STRING, default: 'invert(1) grayscale(100)') // Not sure if this should be a specific type
    )
    {
    }
