<template>
  <AppLayout>
    ...
    <template #sidebar>
      <div class="list-group list-group-flush">
        ...
        <div class="list-group-item">
          <ColorPickerInput label="background color" id="background-color" v-model="variables.background"/>
        </div>
        <div class="list-group-item">
    ...
    <template #main>
      <!-- Scoped Bootstrap Preview Section -->
      <div id="custom-bootstrap-section" :style="style">
        <div class="bd-cheatsheet container-fluid">
          <p class="text-primary">This is a primary text preview.</p>
          <button class="btn btn-primary">Primary Button</button>
        </div>
        <div class="bd-cheatsheet container-fluid ">
          <p class="text-white">This is a preview section with your selected primary color!</p>
                  ...
                  <div class="bd-example-snippet bd-code-snippet">
                    <div class="bd-example m-0 border-0">
                      ...
                      <svg class="bd-placeholder-img img-thumbnail" width="200" height="200"
                        ...
                        placeholder image with a white border around it, making it resemble a
                      ...
                      <nav class="navbar navbar-expand-lg -tertiary">
                        <div class="container-fluid">
                          <a class="navbar-brand" href="#">
                            <img src="/docs/5.3/assets/brand/bootstrap-logo-white.svg" width="38"
                  ...
                  <div class="bd-example-snippet bd-code-snippet">
                    <div class="bd-example m-0 border-0">
                      ...
                      <div class="progress mb-3" role="progressbar"
                           aria-label="Success example with label" aria-valuenow="25" aria-valuemin="0"
                           aria-valuemax="100">
                      ...
                      <div class="progress mb-3" role="progressbar"
                           aria-label="Warning example with label" aria-valuenow="75" aria-valuemin="0"
                           aria-valuemax="100">
                    ...
                    <div class="bd-example m-0 border-0">
                      ...
                      <div class="progress-stacked">
                        <div class="progress" role="progressbar"
                             aria-label="Segment one - default example" style="width: 15%"
              ...
              <article class="my-3" id="scrollspy">
                ...
                <div>
                  <div class="bd-example">
                    <nav id="navbar-example2" class="navbar -tertiary px-3">
...
export default {
  ...
  computed: {
    style() {
      return {
        '--background-color': this.variables.background,
        '--bs-primary': this.variables.primary,
        '--bs-secondary': this.variables.secondary,
      };
    },
  }
};
